...
<body>
                ...
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="dropdown nav-item"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#" style="color: rgb(255,255,255);">Hello, <?php echo $_SESSION["fnamePassing"]?></a>
                            <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="#">Edit Record</a><a class="dropdown-item" role="presentation" href="#">Change Password</a><a class="dropdown-item" role="presentation" href="login.php">Logout</a></div>
                        </li>
                    </ul>
            </div>
    </div>
    ...
    <div class="login-clean" method="POST">
        <form method="post" style="background-color: #3b77b6;" action="confirm/confirmMarriages.php">
            <h1 class="text-center" style="color: rgb(255,255,255);">Marriage</h1>
            <div class="form-group"><label style="color: rgb(255,255,255);">Spouse One:</label><input class="form-control" type="text" name="spouse1" required="" placeholder="Doe, John"></div>
            <div class="form-group"><label style="color: rgb(255,255,255);">Spouse Two:</label><input class="form-control" type="text" name="spouse2" required="" placeholder="Doe, Jane"></div>
            <div class="form-group"><label style="color: rgb(255,255,255);">Marriage Date:</label><input class="form-control" type="date" required="" name="date"></div>
