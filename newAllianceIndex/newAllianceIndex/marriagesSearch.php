...
<body>
    ...
    <div class="login-clean">
        <form action="marriagesResults.php" method="post">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration">
                <h3 id="form-heading">Search The Marriages</h3>
            </div>
            <div class="form-group"><input class="form-control" type="search" name="keywordSearch" placeholder="Enter Name Here" id="form-search" style="background-color: rgb(255,255,255);"></div>
