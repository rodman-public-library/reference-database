...
<body>
    ...
    <div class="login-clean">
        <form action="obitResults.php" method="post">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration">
                <h3 id="form-heading">Search Obituaries</h3>
            </div>
            ...
            <p class="text-center" style="color: rgb(255,255,255);">---- OR ---- <br> If you know the date enter it. If you only know the Year, enter 01/01/YEAR where YEAR is the known year.</p><input class="form-control" type="date" name="dateSearch">
